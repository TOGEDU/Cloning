...
import { RootStackParamList } from '../navigation/types'; // 정확한 경로로 수정
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          <Svg
            ...
            height="35"
            viewBox="0 0 35 35"
            fill={currentRoute === 'Home' ? 'white' : 'none'}
            fillOpacity={currentRoute === 'Home' ? '1' : '0.6'}
          >
            <Path
        ...
        >
          <Svg
            ...
            height="28"
            viewBox="0 0 26 28"
            fill={currentRoute === 'Achieve' ? 'white' : 'none'}
            fillOpacity={currentRoute === 'Achieve' ? '1' : '0.6'}
          >
            <Path
        ...
        >
          <Svg
            ...
            height="28"
            viewBox="0 0 24 28"
            fill={currentRoute === 'MyPage' ? 'white' : 'none'}
            fillOpacity={currentRoute === 'MyPage' ? '1' : '0.6'}
          >
            <Path
