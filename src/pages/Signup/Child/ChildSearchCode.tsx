...
const ChildSearchCode: React.FC = () => {
  const [text, onChangeText] = useState<string>(''); // string 타입 명시
  const [isValidCode, setIsValidCode] = useState<boolean>(false); // boolean 타입 명시
